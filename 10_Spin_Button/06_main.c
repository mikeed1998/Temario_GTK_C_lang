...
void main(void)
{
	...
	g_signal_connect_swapped(adjustment, "changed", G_CALLBACK(adjustment_callback), adjustment);
	...
	g_object_set(adjustment, "upper", 			150.0, 	NULL);
	g_object_set(adjustment, "step-increment", 	2.0, 	NULL);
	g_object_set(adjustment, "page-increment", 	20.0, 	NULL);
	g_object_set(adjustment, "page-size", 		10.0, 	NULL);
