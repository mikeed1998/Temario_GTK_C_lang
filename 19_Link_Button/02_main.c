...
void main(void)
{
	...
	g_print("The link name is called %s\n", gtk_link_button_get_uri(GTK_LINK_BUTTON(linkButton)));

	gtk_link_button_set_uri(GTK_LINK_BUTTON(linkButton), "www.gnome.org");

	g_print("The new link name is called now %s\n", gtk_link_button_get_uri(GTK_LINK_BUTTON(linkButton)));
