...
void main(void)
{
	...
	// g_signal_connect_swapped(scale, "change-value", G_CALLBACK(change_value_callback), scale);
	g_signal_connect_swapped(scale, "adjust-bounds", G_CALLBACK(adjust_bounds_callback), scale);
