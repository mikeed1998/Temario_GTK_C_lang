...
gboolean pressed_callback(GtkWidget*, GdkEventButton*, gpointer);
gboolean released_callback(GtkWidget*, GdkEventButton*, gpointer);
...
void main(void)
{
	...
	g_signal_connect(button, "button-press-event", 	 G_CALLBACK(pressed_callback), 		window);
	g_signal_connect(button, "button-release-event", G_CALLBACK(released_callback), 	window);
...
gboolean pressed_callback(GtkWidget *widget, GdkEventButton *event, gpointer user_data)
{
	(void)widget;
	...
	if(event->type == GDK_BUTTON_PRESS)
	{
		switch(event->button)
		{
			case 1:
				...
				gtk_window_set_title(GTK_WINDOW(user_data), "Left-Click button was pressed");
				return FALSE;
				break;
			case 2:
				g_print("Middle-Click button was pressed\n");
				gtk_window_set_title(GTK_WINDOW(user_data), "Middle-Click button was pressed");
				return FALSE;
				break;
			case 3:
				g_print("Right-Click button was pressed\n");
				gtk_window_set_title(GTK_WINDOW(user_data), "Right-Click button was pressed");
				return FALSE;
				break;
			default:
				return TRUE;
...
gboolean released_callback(GtkWidget *widget, GdkEventButton *event, gpointer user_data)
{
	(void)widget;
	...
	if(event->type == GDK_BUTTON_RELEASE)
	{
		...
		{
			case 1:
				g_print("\tLeft-Click button was released\n");
				gtk_window_set_title(GTK_WINDOW(user_data), "Left-Click button was released");
				return FALSE;
				break;
			case 2:
				g_print("\tMiddle-Click button was released\n");
				gtk_window_set_title(GTK_WINDOW(user_data), "Middle-Click button was released");
				return FALSE;
				break;
			case 3:
				g_print("\tRight-Click button was released\n");
				gtk_window_set_title(GTK_WINDOW(user_data), "Right-Click button was released");
				return FALSE;
				break;
			default:
				return TRUE;
