...
void run_dialog_callback(GtkWindow *window)
{
	...
	g_signal_connect_swapped(dialog, "close", G_CALLBACK(close_callback), dialog);
	...
	gtk_dialog_add_action_widget(GTK_DIALOG(dialog), entry, 4);
