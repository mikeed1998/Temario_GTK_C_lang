...
void main(void)
{
	...
	// gtk_entry_set_icon_tooltip_text(GTK_ENTRY(entry), GTK_ENTRY_ICON_SECONDARY, "Click the icon"); // NULL
	gtk_entry_set_icon_tooltip_markup(GTK_ENTRY(entry), GTK_ENTRY_ICON_SECONDARY, "<span color=\"red\">Click the icon</span>"); // NULL
