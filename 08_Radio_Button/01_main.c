...
void main(void)
{
	...
	radio_button2 = gtk_radio_button_new_with_label(NULL, "Click the button");
	radio_button3 = gtk_radio_button_new_with_mnemonic(NULL, "_Click the button");

	gtk_grid_attach(GTK_GRID(grid), radio_button, 	0, 0, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), radio_button2, 	0, 1, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), radio_button3, 	0, 2, 1, 1);
