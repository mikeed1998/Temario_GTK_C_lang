...
void main(void)
{
	...
	new_radio_button = gtk_radio_button_new_from_widget(GTK_RADIO_BUTTON(radio_button));
	gtk_grid_attach(GTK_GRID(grid), new_radio_button, 0, 1, 1, 1);

	new_radio_button2 = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(radio_button), "Now click me");
	gtk_grid_attach(GTK_GRID(grid), new_radio_button2, 0, 2, 1, 1);	

	new_radio_button3 = gtk_radio_button_new_with_mnemonic_from_widget(GTK_RADIO_BUTTON(radio_button), "_This is a mnemonic button");
