...
void main(void)
{
	...
	//g_signal_connect_swapped(entry, "changed", G_CALLBACK(changed_callback), window);
	//g_signal_connect_swapped(entry, "delete-text", G_CALLBACK(delete_text_callback), window);
	g_signal_connect_swapped(entry, "insert-text", G_CALLBACK(insert_text_callback), window);
